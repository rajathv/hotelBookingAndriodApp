...
public class Screen6 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label1.Text("Taj Falaknuma Palace");
    ...
    Label2.Text("Experience Nizami grandeur at Taj Falaknuma Palace,");
    ...
    Label3.Text("Residence of the Nizam has been lovingly restored");
