...
public class Screen5 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.Text("The iconic sea-facing landmark in Colaba,South Mumbai");
    ...
    Label3.Text("Taj hotel offers you splendid views of the Arabian Sea and Gateway of India");
