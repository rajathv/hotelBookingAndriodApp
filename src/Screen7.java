...
public class Screen7 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.Text("83 rooms and suites featuring white marble walls");
    ...
    Label3.Text("Lake Palace is located on the island of Jag Niwas ");
